...
namespace PortfolioApi.Migrations
{
    ...
    [Migration("20220907075030_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PortfolioApi.Models.HomeContent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ProfilePicUrl = "/static/media/portfolio-profile-pic.2c34d6e051355452a3f1.jpg",
                            Text = "Hi! I am 28 years old and work as a full stack .Net developer! My biggest interest is building complex algorithms to solve problems of mathematical nature, but any kind of data-processing is interesting to me, which is why I am a developer!"
                        });
                });

            modelBuilder.Entity("PortfolioApi.Models.HomeHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("HomeHistory");

                    b.HasData(
                        new
                        {
                            Id = 1,
                            Text = "During the summer of 2022, I participated in a 3 month long .NET fullstack bootcamp given by the School of applied technology, aka <salt/>. Thanks to that, I am today a .NET fullstack developer."
                        },
                        new
                        {
                            Id = 2,
                            Text = "Before that, I studied for a bachelor's degree at Stockholm University. About half my courses were in mathematics, the other half were in philosophy and logic. One of these courses was called \"programming for mathematicians\", where I learned how to code in Python. I learned the basics of Python, i.e. how to make functions and some of the inbuilt functions. Our final project was to code a board-game called Kalaha, that two users can play with each other, or alternatively one user against a script. Part of the project was also to create a program where two different scripts play thousands of games against each other, and gather the win-rates of these scripts to see if one script is better than the other."
                        },
                        new
                        {
                            Id = 3,
                            Text = "This opened the door to programming for me, and led me to seek further education in coding. I ultimately found my way to <salt/>, and now I am doing web-development for a living!"
                        });
                });

            modelBuilder.Entity("PortfolioApi.Models.HomeLinks", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
